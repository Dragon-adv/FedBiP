...
def parse_args():
    ...
    parser.add_argument("--train_data_dir", type=str, default=os.path.join("datasets", "person"))
    parser.add_argument("--output_dir", type=str, default=os.path.join("exps", "domainnet"))
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Number of DataLoader worker processes. Forced to 0 by default for Windows to avoid deadlocks/pickle issues.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Alias for log_every_steps for quick verification / debugging (e.g. --save_steps 1).",
    )
    parser.add_argument(
        "--num_epochs",
        type=int,
        default=50,
        help="Classifier training epochs for clf_train.py (independent from diffusion num_train_epochs).",
    )
    ...
    parser.add_argument('--image_dir', type=str, default=os.path.join("images"))
